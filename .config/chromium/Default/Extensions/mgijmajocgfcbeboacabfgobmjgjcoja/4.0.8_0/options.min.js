...
E();chrome.storage.local.get("word-history",function(a){r=a=Object.keys(a["word-history"]).length;t.innerHTML=a;F()})},F=function(){0<r&&q.checked?(w.disabled=!1,y.disabled=!1):0===r&&(w.disabled=!0,y.disabled=!0)},H=function(a){var b="";a=a["word-history"];for(var c in a){var p=c.split("<"),I=a[c];b+=p[0];b+="\t";b+=p[1];b+="\t";b+=p[2];b+="\t";b+=I;b+="\n"}x.href=window.URL.createObjectURL(new Blob([b],{type:"text/plain"}));b=x;c=document.createEvent("MouseEvents");c.initEvent("click",!0,!0);b.dispatchEvent(c)},
